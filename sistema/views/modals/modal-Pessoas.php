                ...
                <form id="formEditarFuncionario">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="editFuncionarioCom" required placeholder="15%">
                                <div class="input-group-append">
                ...
                <form id="formEditarCliente">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="editClienteTel" required placeholder="(00) 00000-0000">
                        </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <form id="formInserirFuncionario">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="novoFuncionarioCom" required placeholder="10%">
                                <div class="input-group-append">
                ...
                <form id="formInserirFornecedor">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="novoFornecedorTel" required placeholder="(00) 00000-0000">
                        </div>
                        <div class="form-group col-md-6">
                ...
                <form id="formInserirCliente">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="novoClienteTel" required placeholder="(00) 00000-0000">
                        </div>
                </form>
            </div>
            <div class="modal-footer">
