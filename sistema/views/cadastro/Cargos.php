...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <button onclick="btnInserirCargo()" style="background-color: #337ab7; border: #337ab7; border-radius: 5px; color: #fff; padding: 7px 18px;"><img style="width: 30px; margin-left: -10px; margin-right: 7px;" src="../../assets/images/icons/icon_cargo.png"> NOVO CARGO</button>
        <br>
        <br>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="tile-body">
                        <div class="table-responsive">
                            <table  data-order='[[ 0, "desc" ]]' class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody id="cargosTableBody" style="position: relative;">
                                <div id="loadingIndicator4" style="display: none; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
