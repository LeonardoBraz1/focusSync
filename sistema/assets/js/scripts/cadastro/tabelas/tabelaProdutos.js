        ...
        success: function(response) {
            ...
            produtosTableBody.empty();
                ...
                for (var i = 0; i < produtos.length; i++) {
                    ...
                    actions.append("<input style='display: none;' type='button' class='btnVerProduto'  onclick='verProduto(" + produto.id_pro + ", \"" + produto.nome_pro + "\", \"" + produto.valor_compra + "\", \"" + produto.data_cadastro + "\", \"" + produto.valor_venda + "\", \"" + produto.estoque + "\", \"" + produto.validade + "\", \"" + produto.alerta_estoque + "\", \"" + produto.descricao + "\", \"" + produto.imagemSrc + "\", \"" + produto.id_fornecedor + "\")' id='btnVerProduto-" + produto.id_pro + "'>");
